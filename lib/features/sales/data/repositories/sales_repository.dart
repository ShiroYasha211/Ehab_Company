...
import 'package:ehab_company_admin/features/sales/presentation/controllers/add_sales_invoice_controller.dart'; // سنقوم بإنشاء هذا لاحقًا
  ...
  required double totalAmount,
    ...
    await db.transaction((txn) async {
      ...
      for (final item in items) {
        ...
        final product = (await txn.query('products', where: 'id = ?', whereArgs: [item.product.id])).first;
