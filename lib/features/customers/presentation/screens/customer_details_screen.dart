...
class CustomerDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CustomerDetailsController controller = Get.put(
      CustomerDetailsController(customer),
    );
  ...
  Widget _buildHeader(
    ...
    final balanceColor = currentCustomer.balance > 0
        ...
        child: Column(
          children: [
            ...
            _buildInfoRow(
              ...
              'الهاتف',
              currentCustomer.phone ?? 'غير محدد',
            ),
            _buildInfoRow(
              Icons.business_outlined,
              'الشركة',
              currentCustomer.company ?? 'غير محدد',
            ),
            _buildInfoRow(
              Icons.location_on_outlined,
              'العنوان',
              currentCustomer.address ?? 'غير محدد',
            ),
            _buildInfoRow(
              Icons.email_outlined,
              'البريد الإلكتروني',
              currentCustomer.email ?? 'غير محدد',
            ),
          ],
        ),
      ),
      ...
      child: ListTile(
        ...
        title: Column(
          ...
          children: [
            ...
            Row(
              crossAxisAlignment:
                  CrossAxisAlignment.start, // لمحاذاة العناصر من الأعلى
              children: [
                // --- بداية التعديل ---
