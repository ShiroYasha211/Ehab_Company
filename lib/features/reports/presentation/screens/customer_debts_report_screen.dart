...
class CustomerDebtsReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final CustomerDebtsReportController controller = Get.put(
      CustomerDebtsReportController(),
    );
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('تقرير ديون العملاء')),
        ...
        child: SafeArea(
          child: Obx(() {
            ...
            if (controller.indebtedCustomers.isEmpty) {
              return const Center(
                child: Text(
                  'لا يوجد عملاء عليهم ديون حاليًا.',
            ...
            return Column(
              children: [
                ...
                Padding(
                  ...
                  child: Obx(
                    () => SegmentedButton<CustomerDebtSortOrder>(
                      segments: const [
                        ButtonSegment(
  ...
  Widget _buildSummaryCard(
    CustomerDebtsReportController controller,
